...
if __name__ == '__main__':
    # Default to Fluid Gerrit
    default_gerrit = 'https://review.fluidos.me'

    parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter, description=textwrap.dedent('''\
        repopick.py is a utility to simplify the process of cherry picking
        patches from Fluid's Gerrit instance (or any gerrit instance of your choosing)
    ...
    for change in change_numbers:
        ...
        mergables.append({
            ...
            'project': review['project'].replace("Project-Fluid/", ""),
    ...
    for item in mergables:
        ...
        project_path = None
        item['project'].replace("Project-Fluid/", "")
