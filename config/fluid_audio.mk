...
ALARM_PATH := vendor/fluid/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/fluid/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/fluid/prebuilt/common/media/audio/ringtones
